...
import { Settings, Zap, Headphones, Target, Shield, CheckCircle2, ArrowRight, Eye, Target as TargetMission } from "lucide-react";
          ...
          <div className="flex-1">
            <FadeUp delay={150}>
              ...
              <blockquote className="text-[#6B7280] text-base leading-relaxed italic border-l-4 border-[#59D66F] pl-5 py-1 mb-8">
                &ldquo;Our commitment has always been to deliver solutions that truly solve our client&apos;s challenges. We believe that engineering is not just about technology, but it is about understanding needs, creating value, and building long-term partnership.
                <br /><br />
                We will continue to invest in our people, technology, and processes so we can provide solutions you can rely on, today and in the future.&rdquo;
              </blockquote>
              <div>
